         ...
         <nav class="navbar navbar-inverse navbar-fixed-top striped-bg" id="top-navbar">
            <div class="container-fluid">
               <div class="navbar-header">
                  ...
                  <div class="solution">&gt;&nbsp;Seremos cada día mejores.</div>
               </div>
                  ...
                  <ul>
                     <li class="dropdown hidd">
                        ...
                        <ul class="dropdown-menu admin" role="menu">
                           ...
                           <li><a href="http://another.cl/profile"><i class="fa fa-info"></i> Profile</a></li>
                           <li><a href="http://another.cl/auth/logout"><i class="fa fa-power-off"></i> Logout</a></li>
         ...
         <div class="striped-bg" id="sidenav">
            <div role="tabpanel" id="navTabs">
               <div class="sidebar-controllers">
                  ...
                  <div class="">
                     <div class="tab-content-scroller tab-content sidebar-section-wrap ps-container ps-active-y" data-ps-id="b8d46890-9416-5bf2-4c39-bf07b2f22fc8">
                        <div role="tabpanel" class="tab-pane active" id="menu">
                           <div class="photo-container text-center">
                              <a href="http://another.cl/profile">
                           ...
                           <ul class="nav sidebar-nav ">
                              <li class="active"><a href="http://another.cl"><i class="fa fa-home"></i> Home</a></li>
                              ...
                              <li><a href="http://another.cl/panel"><i class="fa fa-bookmark-o"></i> Usuarios</a></li>

                              <li class="sidenav-dropdown">
                                 <a class="subnav-toggle" href="#"><i class="fa fa-pencil "></i> Reportes <i class="fa fa-angle-down fa-angle-down  pull-right"></i></a>
                                 <ul class="nav sidenav-sub-menu">
                                    <li><a href="http://another.cl/messages/inbox"><i class="fa fa-inbox"></i> Reporte 1</a></li>
                                    <li><a href="http://another.cl/messages/compose"><i class="fa fa-pencil-square-o"></i> Reporte 2</a></li>
                                 </ul>
                              </li>
                        ...
                        <div role="tabpanel" class="tab-pane" id="comments">
                           ...
                           <ul class="online-members">
                              <li><a href=""><img class="img-circle chat-image" src="{{Auth::user()->img}}" alt="">Kumar Sanket <i class="fa fa-circle pull-right text-success"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Kumar Pratik <i class="fa fa-circle pull-right text-success"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Megha Kumari <i class="fa fa-circle pull-right text-success"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Sankhadeep Roy <i class="fa fa-circle pull-right text-success"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/profile.jpg" alt="">Suraj Ahmad Choudhury <i class="fa fa-circle pull-right text-success"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="{{Auth::user()->img}}" alt="">Kumar Sanket <i class="fa fa-circle pull-right text-warning"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Megha Kumari <i class="fa fa-circle pull-right text-warning"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Kumar Pratik <i class="fa fa-circle pull-right text-warning"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Mrigank Mridul <i class="fa fa-circle pull-right text-muted"></i></a></li>
                              <li><a href=""><img class="img-circle chat-image" src="http://another.cl/img/user-icon.png" alt="">Amith M S <i class="fa fa-circle pull-right text-muted"></i></a></li>
                           </ul>
                        </div>
                              ...
                              <div class="chart-container">
                                 <div id="sidebar-piechart" class="c3" style="max-height: 140px; position: relative;">
                                    <svg width="140" height="140" style="overflow: hidden;">
                                       <defs>
                                          <clipPath id="c3-1492638886556-clip">
                                             <rect width="140" height="116"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886556-clip-xaxis">
                                             <rect x="-31" y="-20" width="202" height="40"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886556-clip-yaxis">
                                             <rect x="-29" y="-4" width="20" height="140"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886556-clip-grid">
                                             <rect width="140" height="116"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886556-clip-subchart">
                                             <rect width="140"></rect>
                                          </clipPath>
                                       </defs>
                                       <g transform="translate(0.5,4.5)">
                                          ...
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip)" class="c3-regions" style="visibility: hidden;"></g>
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip-grid)" class="c3-grid" style="visibility: hidden;">
                                             <g class="c3-xgrid-focus">
                                                <line class="c3-xgrid-focus" x1="-10" x2="-10" y1="0" y2="116" style="visibility: hidden;"></line>
                                             </g>
                                          </g>
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip)" class="c3-chart">
                                             ...
                                             <g class="c3-chart-arcs" transform="translate(70,53)">
                                                ...
                                                <g class="c3-chart-arc c3-target c3-target-1">
                                                   <g class=" c3-shapes c3-shapes-1 c3-arcs c3-arcs-1">
                                                      <path class=" c3-shape c3-shape c3-arc c3-arc-1" transform="" style="fill: rgb(6, 197, 172); cursor: pointer; opacity: 1;" d="M-9.251788222064308,49.49269556908445A50.349999999999994,50.349999999999994 0 0,1 -33.92057565760415,-37.20909898206018L0,0Z"></path>
                                                   </g>
                                                ...
                                                <g class="c3-chart-arc c3-target c3-target-2">
                                                   <g class=" c3-shapes c3-shapes-2 c3-arcs c3-arcs-2">
                                                      <path class=" c3-shape c3-shape c3-arc c3-arc-2" transform="" style="fill: rgb(63, 170, 227); cursor: pointer; opacity: 1;" d="M3.0830483168534612e-15,-50.349999999999994A50.349999999999994,50.349999999999994 0 1,1 -9.251788222064308,49.49269556908445L0,0Z"></path>
                                                   </g>
                                                ...
                                                <g class="c3-chart-arc c3-target c3-target-3">
                                                   <g class=" c3-shapes c3-shapes-3 c3-arcs c3-arcs-3">
                                                      <path class=" c3-shape c3-shape c3-arc c3-arc-3" transform="" style="fill: rgb(238, 99, 76); cursor: pointer; opacity: 1;" d="M-33.92057565760415,-37.20909898206018A50.349999999999994,50.349999999999994 0 0,1 -9.249144950560384e-15,-50.349999999999994L0,0Z"></path>
                                                   </g>
                                          ...
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip-grid)" class="c3-grid c3-grid-lines">
                                             <g class="c3-xgrid-lines"></g>
                                             <g class="c3-ygrid-lines"></g>
                                          </g>
                                          <g class="c3-axis c3-axis-x" clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip-xaxis)" transform="translate(0,116)" style="visibility: visible; opacity: 0;">
                                          ...
                                          <g class="c3-axis c3-axis-y" clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip-yaxis)" transform="translate(0,0)" style="visibility: visible; opacity: 0;">
                                       ...
                                       <g transform="translate(0.5,140.5)" style="visibility: hidden;">
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip-subchart)" class="c3-chart">
                                             <g class="c3-chart-bars"></g>
                                             <g class="c3-chart-lines"></g>
                                          </g>
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip)" class="c3-brush" style="pointer-events: all; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                          ...
                                          <g class="c3-axis-x" transform="translate(0,0)" clip-path="url(http://another.cl/messages/invoice#c3-1492638886556-clip-xaxis)" style="opacity: 0;">
                                             <g class="tick" transform="translate(70, 0)" style="opacity: 1;">
                                                <line y2="6" x1="0" x2="0"></line>
                                                <text y="9" x="0" transform="" style="text-anchor: middle; display: block;">
                                                   <tspan x="0" dy=".71em" dx="0">0</tspan>
                              ...
                              <div class="chart-container2">
                                 <div id="sidebar-barchart" class="c3" style="max-height: 120px; position: relative;">
                                    <svg width="200" height="120" style="overflow: hidden;">
                                       <defs>
                                          <clipPath id="c3-1492638886627-clip">
                                             <rect width="197" height="66"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886627-clip-xaxis">
                                             <rect x="-31" y="-20" width="259" height="70"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886627-clip-yaxis">
                                             <rect x="-29" y="-4" width="21" height="90"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886627-clip-grid">
                                             <rect width="197" height="66"></rect>
                                          </clipPath>
                                          <clipPath id="c3-1492638886627-clip-subchart">
                                             <rect width="197"></rect>
                                          </clipPath>
                                       </defs>
                                       <g transform="translate(1.5,4.5)">
                                          ...
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip)" class="c3-regions" style="visibility: visible;"></g>
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip-grid)" class="c3-grid" style="visibility: visible;">
                                             <g class="c3-xgrid-focus">
                                                <line class="c3-xgrid-focus" x1="-10" x2="-10" y1="0" y2="66" style="visibility: hidden;"></line>
                                             </g>
                                          </g>
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip)" class="c3-chart">
                                             <g class="c3-event-rects c3-event-rects-single" style="fill-opacity: 0;">
                                          ...
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip-grid)" class="c3-grid c3-grid-lines">
                                             <g class="c3-xgrid-lines"></g>
                                             <g class="c3-ygrid-lines"></g>
                                          </g>
                                          <g class="c3-axis c3-axis-x" clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip-xaxis)" transform="translate(0,66)" style="visibility: visible; opacity: 1;">
                                          ...
                                          <g class="c3-axis c3-axis-y" clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip-yaxis)" transform="translate(0,0)" style="visibility: hidden; opacity: 1;">
                                             <text class="c3-axis-y-label" transform="rotate(-90)" x="0" dx="-0.5em" dy="1.2em" style="text-anchor: end;"></text>
                                             <g class="tick" transform="translate(0,66)" style="opacity: 1;">
                                                <line x2="-6"></line>
                                                <text x="-9" y="0" style="text-anchor: end;">
                                       ...
                                       <g transform="translate(1.5,120.5)" style="visibility: hidden;">
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip-subchart)" class="c3-chart">
                                             <g class="c3-chart-bars"></g>
                                             <g class="c3-chart-lines"></g>
                                          </g>
                                          <g clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip)" class="c3-brush" style="pointer-events: all; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                          ...
                                          <g class="c3-axis-x" transform="translate(0,0)" clip-path="url(http://another.cl/messages/invoice#c3-1492638886627-clip-xaxis)" style="opacity: 1;">
                                             <g class="tick" transform="translate(11, 0)" style="opacity: 1;">
                                                <line y2="6" x1="0" x2="0"></line>
                                                <text y="9" x="0" transform="" style="text-anchor: middle; display: block;">
                                                   <tspan x="0" dy=".71em" dx="0">0</tspan>
      ...
      <script>
         window.Laravel = {!! json_encode([
             'csrfToken' => csrf_token(),
                        ...
                        <div class="ps-scrollbar-y-rail" style="top: 0px; height: 811px; right: 3px;">
                           <div class="ps-scrollbar-y" style="top: 0px; height: 758px;"></div>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div id="body-container">
            <div class="page-title clearfix">
               <div class="pull-left">
                  ...
                  <small class="subtitle">Este es un subtitulo
                  </small>
               </div>
